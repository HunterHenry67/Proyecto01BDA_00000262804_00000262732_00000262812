 ...
 * @author Andre
 */
public class frmGestionEquipos extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(frmGestionEquipos.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new frmGestionEquipos().setVisible(true));
    }
